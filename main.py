...
def main():
    ...
    parser = argparse.ArgumentParser(description="Run different parts of the ML pipeline.")

    parser.add_argument("--prepare", action="store_true", help="Prepare data")
    parser.add_argument("--train", action="store_true", help="Train the model")
    parser.add_argument("--evaluate", action="store_true", help="Evaluate the model")
    parser.add_argument("--predict", action="store_true", help="Generate predictions")
    parser.add_argument("--all", action="store_true", help="Run the full pipeline (prepare → train → evaluate → save)")
    ...
    if args.all:
        ...
        model = model_pipeline.train_model()
